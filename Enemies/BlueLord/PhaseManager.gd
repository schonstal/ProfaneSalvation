...
func _ready():
  ...
  blue_lord.connect("fade_in_completed", Callable(self, "_on_BlueLord_fade_in_completed"))
  blue_lord.connect("fade_out_completed", Callable(self, "_on_BlueLord_fade_out_completed"))
